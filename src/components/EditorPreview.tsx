      ...
      <div className="mx-auto w-full max-w-5xl px-6 py-10">
        {heroFirst ? (
          (() => {
            ...
            return (
              <header
                className="mb-6 rounded-3xl border border-zinc-200 bg-white p-10 shadow-sm"
          ...
          <header className="mb-6 rounded-3xl border border-zinc-200 bg-white p-10 shadow-sm">
            <p className="text-xs font-medium uppercase tracking-wide text-zinc-500">
              @{username}
            </p>
